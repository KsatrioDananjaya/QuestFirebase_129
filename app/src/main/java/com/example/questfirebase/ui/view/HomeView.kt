...
import com.example.questfirebase.ui.viewmodel.HomeUiState
import com.example.questfirebase.ui.viewmodel.HomeViewMod
...
fun HomeView(
    ...
    viewModel: HomeViewMod = viewModel(factory = PenyediaViewmod.Factory)
){
